...
- [co-cart/co-cart](https://github.com/co-cart/co-cart) ([v4.3.16](https://github.com/co-cart/co-cart/releases/tag/v4.3.16), 1 day ago) - 🛒 CoCart&#39;s developer-friendly REST API integrates with WooCommerce to decouple your storefront and convert it blazing-fast, build in any web framework.
...
- [chillerlan/php-qrcode](https://github.com/chillerlan/php-qrcode) - A PHP QR Code generator and reader with a user-friendly API. (5 days ago)
- [endroid/qr-code](https://github.com/endroid/qr-code) - QR Code Generator (5 days ago)
- [kylefox/jquery-modal](https://github.com/kylefox/jquery-modal) - The simplest possible modal for jQuery (5 days ago)
