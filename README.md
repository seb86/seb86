...
- [cocart-headless/cocart-admin](https://github.com/cocart-headless/cocart-admin) - Package contains all the core admin features of CoCart. (4 months ago)
...
- [cocart-headless/cocart-rate-limiting](https://github.com/cocart-headless/cocart-rate-limiting) ([v1.0.1](https://github.com/cocart-headless/cocart-rate-limiting/releases/tag/v1.0.1), 9 months ago) - Enables the rate limiting feature for CoCart Plus or higher.
