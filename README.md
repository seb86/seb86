...
- [cocart-headless/cocart-sniffs](https://github.com/cocart-headless/cocart-sniffs) - Collection of PHP_CodeSniffer sniffs for CoCart (2 days ago)
...
- [cocart-headless/cocart-sniffs](https://github.com/cocart-headless/cocart-sniffs) ([0.0.3](https://github.com/cocart-headless/cocart-sniffs/releases/tag/0.0.3), 2 days ago) - Collection of PHP_CodeSniffer sniffs for CoCart
- [co-cart/co-cart](https://github.com/co-cart/co-cart) ([v3.12.0-pre.1](https://github.com/co-cart/co-cart/releases/tag/v3.12.0-pre.1), 5 days ago) - 🛒 CoCart makes it easy to decouple your WooCommerce store via a customizable REST API that takes the pain out of developing – allowing you to build fast and flexible headless stores.
...
- [ibericode/vat-rates](https://github.com/ibericode/vat-rates) - Community maintained resource for VAT rates of EU member states (6 days ago)
