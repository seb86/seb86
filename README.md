...
- [firebase/php-jwt](https://github.com/firebase/php-jwt) - PHP package for JWT (1 day ago)
- [mpv-player/mpv](https://github.com/mpv-player/mpv) - 🎥 Command line video player (5 days ago)
