...
- [co-cart/co-cart](https://github.com/co-cart/co-cart) ([v4.6.0](https://github.com/co-cart/co-cart/releases/tag/v4.6.0), 1 day ago) - Build modern headless stores with WooCommerce faster — with the REST API purpose-built for developers.
- [cocart-headless/cocart-jwt-authentication](https://github.com/cocart-headless/cocart-jwt-authentication) ([v2.5.1](https://github.com/cocart-headless/cocart-jwt-authentication/releases/tag/v2.5.1), 1 week ago) - This free add-on for CoCart allows you to authenticate via a simple JWT Token.
...
- [Update translations from GlotPress](https://github.com/cocart-headless/cocart-jwt-authentication/pull/25) on [cocart-headless/cocart-jwt-authentication](https://github.com/cocart-headless/cocart-jwt-authentication) (4 days ago)
