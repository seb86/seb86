...
- [CoCart Plus v1.2.0 Released](https://cocart.dev/cocart-plus-v1-2-0-released/) (4 days ago)
...
- [cocart-headless/cocart-benchmark-performance](https://github.com/cocart-headless/cocart-benchmark-performance) - Only whitelisted plugins will load when requesting CoCart to improve performance. (3 days ago)
...
- [cocart-headless/cocart-benchmark-performance](https://github.com/cocart-headless/cocart-benchmark-performance) ([v0.0.2](https://github.com/cocart-headless/cocart-benchmark-performance/releases/tag/v0.0.2), 3 days ago) - Only whitelisted plugins will load when requesting CoCart to improve performance.
- [co-cart/co-cart](https://github.com/co-cart/co-cart) ([v3.10.5](https://github.com/co-cart/co-cart/releases/tag/v3.10.5), 6 days ago) - 🛒 CoCart makes it easy to decouple your WooCommerce store via a customizable REST API that takes the pain out of developing – allowing you to build fast and flexible headless stores.
...
- [Brugman/decent-looking-emails](https://github.com/Brugman/decent-looking-emails) - A WordPress plugin that upgrades your system emails to HTML, with templates, without a UI. (1 day ago)
