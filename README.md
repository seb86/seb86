...
- [chillerlan/php-qrcode](https://github.com/chillerlan/php-qrcode) - A PHP QR Code generator and reader with a user-friendly API. (2 days ago)
- [endroid/qr-code](https://github.com/endroid/qr-code) - QR Code Generator (2 days ago)
- [kylefox/jquery-modal](https://github.com/kylefox/jquery-modal) - The simplest possible modal for jQuery (2 days ago)
- [discord/discord-api-docs](https://github.com/discord/discord-api-docs) - Official Discord API Documentation (4 days ago)
- [polarsource/polar-js](https://github.com/polarsource/polar-js) - Polar SDK for Node.js and browsers (6 days ago)
