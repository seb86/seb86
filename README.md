...
- [Introducing CoCart Plus Support, Powerful Products API Enhancements and Performance Boost Updates!](https://cocart.dev/introducing-cocart-plus-support-powerful-products-api-enhancements-and-performance-boost-updates/) (1 day ago)
...
- [co-cart/co-cart](https://github.com/co-cart/co-cart) ([v3.11.0](https://github.com/co-cart/co-cart/releases/tag/v3.11.0), 1 day ago) - 🛒 CoCart makes it easy to decouple your WooCommerce store via a customizable REST API that takes the pain out of developing – allowing you to build fast and flexible headless stores.
...
- [CopilotKit/CopilotKit](https://github.com/CopilotKit/CopilotKit) - AI Copilot infrastructure for React apps 🤖 AI-powered Textareas, in-app AI chatbots (with context-awareness &amp; actions), LangChain support, and more!  (4 days ago)
