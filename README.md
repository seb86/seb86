...
- [firebase/php-jwt](https://github.com/firebase/php-jwt) - PHP package for JWT (today)
- [mpv-player/mpv](https://github.com/mpv-player/mpv) - 🎥 Command line video player (4 days ago)
