...
- [CoCart Plus v1.1.0 Released](https://cocart.dev/cocart-plus-v1-1-0-released/) (4 days ago)
...
- [co-cart/co-cart](https://github.com/co-cart/co-cart) ([v3.10.4](https://github.com/co-cart/co-cart/releases/tag/v3.10.4), 5 days ago) - 🛒 CoCart makes it easy to decouple your WooCommerce store via a customizable REST API that takes the pain out of developing – allowing you to build fast and flexible headless stores.
...
- [huozhi/sugar-high](https://github.com/huozhi/sugar-high) - ✏️ Super lightweight JSX syntax highlighter, around 1KB after minified and gzipped (today)
